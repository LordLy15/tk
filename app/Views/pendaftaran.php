                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                    ...
                    <form action="<?= base_url('pendaftaran/simpan') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control rounded-3" name="no_hp" placeholder="Contoh: 081234567890" required>
                            <small class="text-muted">Nomor yang aktif dan bisa dihubungi.</small>
                        </div>
